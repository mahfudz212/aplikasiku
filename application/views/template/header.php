...
<body>
    ...
    <div class="page-container">
        ...
        <!-- sidebar menu area end --> <!-- main content area start -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="<?=base_url('assets/')?>/images/author/foto.jpg" alt="avatar">
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">MAHFUDZ<i class="fa fa-angle-down"></i></h4>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="<?=base_url()?>">@mahfudz</a>
